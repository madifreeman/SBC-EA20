    ...
    <div>
      ...
      <div className="relative container bg-white rounded shadow-lg w-full mt-8 pt-2 pb-8 px-8 mx-auto  justify-between">
        ...
        <div className="mt-12 flex justify-center font-semibold">
          <Link href="/startups/manage">
            <a className="block mx-4 shadow-lg text-center py-2 px-4 rounded text-white bg-teal-500 rounded hover:shadow-lg hover:bg-teal-600 w-40">
              Save
            </a>
          </Link>
          <button
